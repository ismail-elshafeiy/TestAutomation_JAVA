...
//        driver = new FirefoxDriver(UploadFile_FireFoxOptions.firefoxOption());
	...
	public void takeWebElementPageSection_Screenshot () throws IOException {
		WebElement appToolsPageSection = driver.findElement(By.cssSelector("#post-8>header"));
	...
	@Test
	public static String takeScreenShot_2 (WebDriver driver, String pictureName) throws IOException {
