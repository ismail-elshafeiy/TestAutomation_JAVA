...
public class ScreenShotTests {
	...
	public void takeFullPage_Screenshot () throws IOException {
		driver = DriverFactory.getBrowser(DriverHelper.BrowserType.FIREFOX, DriverHelper.ExecutionType.LOCAL);
	...
	public void printWindow () throws IOException {
		...
		BrowserActions.navigateToUrl(driver, "https://www.selenium.dev");
		BrowserActions.printPage(driver, 6);
	}

	@Story("Capture Page Snapshot")
	@Test(description = "Capture Page Snapshot")
	@Description("""
			Captures the current page within the browser.
			Note: This requires Chromium Browsers to be in headless mode
			""")
	public void capturePageSnapshot() {
		driver = DriverFactory.getBrowser(DriverHelper.BrowserType.CHROME);
		BrowserActions.navigateToUrl(driver, "https://github.com/ismail-elshafeiy");
