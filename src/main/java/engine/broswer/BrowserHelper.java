...
public class BrowserHelper {
    ...
    protected static final String EXECUTION_TYPE = PropertiesReader.getProperty("project.properties", "executionType");
    protected static final String BROWSER_TYPE = PropertiesReader.getProperty("project.properties", "browserType");
    protected static final String HOST = PropertiesReader.getProperty("project.properties", "host");
    protected static final String PORT = PropertiesReader.getProperty("project.properties", "port");
