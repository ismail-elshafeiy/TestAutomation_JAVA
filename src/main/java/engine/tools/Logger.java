...
public class Logger {
    ...
    public static void logStep(String logStep) {
        System.out.println("<" + Helper.getCurrentTime("dd-MM-yyyy HH:mm:ss.SSS a") + "> " + logStep);
        ExtentReport.info(logStep);
    }


    public static void logMessage(String logMessage) {
        System.out.println("<" + Helper.getCurrentTime("dd-MM-yyyy HH:mm:ss.SSS a") + "> " + logMessage);
